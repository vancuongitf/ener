        ...
        <div class="card-body" style="box-sizing:border-box !important;">
            <table class="border-table" style="width: 100%;">
                ...
                <tr id="{{'post-' . $post->id}}">
                    ...
                    <td style="height:100px; text-align:center;">{{$post->id}}</td>
                    ...
                    <td style="text-align:center;"><input type="checkbox" style="width:30px; height:30px;" {{$post->isHot()}}></td>
                    <td style="text-align:center;"><input type="checkbox" style="width:30px; height:30px;" {{$post->isHighLight()}}></td>
                    <td style="text-align:center;">
                        @if ($post->is_published == 0)
                            <button id="btnPublish-{{$post->id}}" class="btn btn-primary" onclick="publishNow({{$post->id}})">Publish now</button>                            
                        @endif
                    </td>
                    <td style="text-align:center;"><button class="btn btn-primary" onclick="deletePost({{$post->id}})">Delete</button></td>
                </tr>
                @endforeach
